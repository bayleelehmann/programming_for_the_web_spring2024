...
let cardBack;
function preload() {
    cardBack = loadImage('images/cards_rect-01.png');
    cardFaceArray = [
        loadImage('images/cards_rect-02.png'),
        loadImage('images/cards_rect-03.png'),
        loadImage('images/cards_rect-04.png'),
        loadImage('images/cards_rect-05.png'),
        loadImage('images/cards_rect-06.png'),
    ]
}
   ...
   //background(0);
    ...
    for (let j = 0; j < 2; j++) {
        for (let i = 0; i < 5; i++) {
            ...
            cards.push(new Card(startingX, startingY, faceImage));  //cardFaceArray
            startingX += 120;
